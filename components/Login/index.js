      ...
      <FormContainer>
        <form method="POST" className="flex-grow-1">
          ...
          <div className="text-right">
            <a href="#" data-toggle="form" data-slide="left" className="text-dark text-decoration-none">Forgot
                Password?</a>
          </div>
        </form>
        <form className="flex-grow-1" method="post" style={{ display: 'none' }}>
          <a href="/" className="sidebar-brand text-decoration-none">
            <img src="/static/images/80bots.svg" alt=""/>
          </a>
          ...
          <div>
            <a href="#" data-toggle="form" data-slide="right" className="text-dark text-decoration-none">Back
                to Sign In</a>
          </div>
        </form>
      </FormContainer>
      <div className="d-flex align-items-center justify-content-center flex-column">
        <h5 className="text-white mb-0">Not registered? <a href="" className="text-white font-weight-bold">Sign up</a>
        </h5>
      </div>
    </Container>
  );
