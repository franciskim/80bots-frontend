    ...
    send({ type, category: otherCategory || category, message })
      ...
      .catch(() =>
        notify({
          ...
          message: "Can't send report right now"
        })
      );
  };
  ...
  return (
    <>
      <Modal
        ...
        title={"Feedback"}
      >
        <SubTitle>Bug report or improvement suggestions</SubTitle>
        <Select
          styles={styles}
        ...
        {category && (
          <FilesDropZone
            ...
            hint={"Drop some related screenshots here"}
          />
        )}
        <Button disabled={!message} type={"primary"} onClick={submit}>
          Send
        </Button>
      </Modal>
