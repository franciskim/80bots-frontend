import { OPEN_ITEM, CLOSE_ITEM, FLUSH } from './types'
import { listenForWhisper, stopListeningForWhisper } from '../socket/actions'
import { addItem, open } from './actions'
        ...
        case OPEN_ITEM: {
          ...
          const listener = {
            ...
            unsubscribe: function () {
              ...
              return dispatch(
                stopListeningForWhisper(this.channel, this.signal)
              )
            },
            subscribe: function () {
              console.debug('SOCKET: LISTEN', this.signal)
              return dispatch(
                listenForWhisper(this.channel, this.signal, (data) => {
