...
export const formatTimezone = () => {
  const date1 = '2020-07-09 16:50';
  const timezone = 'Europe/Zaporozhye';
  const formatCurrentTime = moment.tz(`${date1}`, `${timezone}`);
  console.log(formatCurrentTime.tz('UTC').format('YYYY-MM-DD HH:mm:ss'));
};